					...
					<Paper className="bg-[#080808] px-[69px] py-24" radius={24}>
						<Stack className="gap-y-16">
							...
							<Group className="justify-between">
								{stats.map((item) => (
									<Box className="text-white" key={item.text}>
			...
			<Box className="pb-[82px]" component="section">
				<PageWrapper>
					<SimpleGrid className="grid-cols-2 gap-x-7">
							...
							<Stack className="gap-y-[14px]">
								...
								<Flex className="gap-x-4">
									...
									<Stack gap={7}>
										...
										<Text className="font-normal text-[#666E82] text-lg leading-[30px]">
											Delivery made easy. We've got you covered with a simple,
											reliable, and fast delivery experience.
										</Text>
									</Stack>
								</Flex>
							</Stack>
						...
						<Paper className="bg-[#0E1628]" radius={24}></Paper>
					</SimpleGrid>
				</PageWrapper>
			</Box>
